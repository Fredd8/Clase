...
public class MainCoche {
		...
		public static void main(String args[]){
			...
			if (coches.contains(coche3)) System.out.println("El coche3 esta en la lista");
			else System.out.println("El coche3 no esta en la lista");
			
			Coche coche4 = new Coche("blanco", "Nissan", "3333-HIJK", 5 ); // Como el coche3
			
			if (coches.contains(coche4)) System.out.println("El coche4 esta en la lista");
			else System.out.println("El coche4 no esta en la lista");
			
			// Ponemos en la configuracion del programa en la opcion Argumentos/VM argumets: -ea
			// Si queremos que salte la excepcion de assert. Se usa para depuracion
			// assert coche3 == coche4;
			
			System.out.println(coches);
			
			if (borraElemento(coches, coche2)) System.out.println("Encontrado y borrado");
			System.out.println(coches);
